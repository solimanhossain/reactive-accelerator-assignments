...
export default function Button() {
    const greencolor = 'bg-[#1C4336]/[14%] py-1.5 text-[#1C4336] hover:bg-[#1C4336]/[24%]';
    const pinkcolor = 'bg-[#DC2954]/[14%] py-1.5 text-[#DC2954] hover:bg-[#DC2954]/[24%]';
    ...
    return (
        ...
        <div className="flex items-center gap-3 text-xs lg:text-sm">
            ...
            <button
                className={"flex min-w-[132px] items-center justify-center gap-1 rounded-md transition-all lg:py-1.5 " + (favourite ? pinkcolor : greencolor)}
                onClick={addToFavourite}>
                {favourite ? <PinkSvg /> : <GreenSvg />}
                Favourite
            </button>
        </div>
    );
